...
with gr.Blocks(title="Robotics Research Copilot") as demo:
    gr.Markdown("# 🤖 Robotics Research Copilot\n### Multimodal RAG + Agentic AI for Robotics & CV Research")
    ...
    with gr.Tabs():
        ...
        with gr.Tab("📝 Paste Text"):
            ...
            text_input = gr.Textbox(label="Paste your text here", placeholder="Paste a paragraph, abstract, or any text...", lines=8)
            text_question = gr.Textbox(label="Your Question", placeholder="What does this text say about...")
